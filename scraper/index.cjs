/**
 * Fixed Deposit Interest Rates Scraper
 * Source: Bank websites (public)
...
async function scrape() {
  console.log('Fixed Deposit Interest Rates Scraper');
  console.log('Source:', 'Bank websites (public)');
